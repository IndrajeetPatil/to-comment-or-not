...
**Don't use [ASCII art](https://www.figlet.org/) comments**
...
::: {.callout-tip title="Review LLM-Generated Comments"}

LLMs can overcomment or generate redundant comments. Review LLM-generated comments critically—either manually or with a different LLM—to evaluate quality and identify unnecessary ones.
