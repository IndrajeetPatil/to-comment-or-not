...
**Note:** Copyright notices and license information are typically part of documentation, not comments.
:::
...
Crutch comments compensate for unclear code—fix the code instead.
...
::: {style="background-color: #FFFBC1; padding: 4px; border-radius: 10px; text-align: center; font-size: 1em;"}
...
- Holovaty, A. (2009). [What to write in a comment](https://jacobian.org/2009/nov/10/what-to-write/)
